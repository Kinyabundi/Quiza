          ...
          <div>
            <div className="flex flex-row gap-4 items-center">
              <div className="flex items-center gap-2">
                <SiSwarm size={60} className="text-[#cbceeb]" />
                <p className="text-[#FFF] text-4xl font-bold">Quiza</p>
              </div>
            </div>
            <img src="https://static.vecteezy.com/system/resources/previews/001/993/315/original/online-test-and-exam-with-people-filling-answer-vector.jpg" alt="quiz" className="object-cover h-[99vh] bg-gray-100" />
          </div>
          {isLoading ?
            (
              <LoadingSpinner />
                ...
                <div className="relative flex items-center justify-center w-full md:w-[11/12] xl:w-[8/12] mx-auto">
                  <div className="flex flex-col">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-short text-gray-900 dark:text-white">
                      <span className="block xl:inline text-[#cbceeb]">Welcome to Quiza</span>
                    </h1>
                    <p className="mt-3 sm:mt-5 md:mt-5 mx-auto sm:mx-0 mb-6 text-lg md:text-xl text-gray-500 leading-base">
                      Empowering freelancers globally with instant payments.
                    </p>
